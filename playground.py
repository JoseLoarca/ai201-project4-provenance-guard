...
if __name__ == '__main__':
    ...
    print('Running full pipeline on AI written text:')
    for ai in ai_text:
        print(f"{ai=:.30}")
        final_score = run(ai)
        print(f"Full pipeline results: {final_score}")
        print(f"Label: {final_score['label']}")
        print(f"Confidence: {final_score['confidence']}")
        print(f"Attribution: {final_score['attribution']}")
        print('-'*50)
        sleep(3)


    print('Running full pipeline on human written text:')
    for human in human_text:
        print(f"{human=:.30}")
        final_score = run(human)
        print(f"Full pipeline results: {final_score}")
        print(f"Label: {final_score['label']}")
        print(f"Confidence: {final_score['confidence']}")
        print(f"Attribution: {final_score['attribution']}")
